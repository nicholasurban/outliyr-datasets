...
Open health-technology data from [Outliyr](https://outliyr.com). Each dataset documents its own sources, methods, and limits. Records can include independently observed measurements, manufacturer specifications, and other clearly labeled source types; a record is not an independent measurement merely because it appears in this repository.

For details on an independent light-therapy test, see the published [testing methodology](https://outliyr.com/light-therapy-testing-methodology) and the individual source record. Manufacturer claims remain separate from Outliyr observations.
